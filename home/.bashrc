...
# edit bashrc file
alias editbrc='vim ~/.bashrc'

# jump to ~/Desktop/programming/c/tutorials/lcthw/
lcthw() { cd ~/Desktop/programming/c/tutorials/lcthw/ ; }
...
alias starwars='urxvt -e sh -c "telnet towel.blinkenlights.nl; bash"'
...
# I remember sublime better than subl. easier this way
alias sublime='subl'
